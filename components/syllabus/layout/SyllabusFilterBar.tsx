...
export default function SyllabusFilterBar({
  ...
  return (
    <div className="bg-[#0A0F1E] border border-white/8 rounded-2xl p-4">
      <div className="grid grid-cols-1 xl:grid-cols-[1.8fr_1fr_1fr_1fr_1fr_auto] gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-3 bg-violet-600 text-white rounded-xl text-sm font-medium hover:bg-violet-500 transition-colors disabled:opacity-40 whitespace-nowrap"
        >
